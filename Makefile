...
# Specify Files
SRC_FILES = src/main.cpp src/example_functions.cpp # List all source files (include src/ directory)
OBJ_FILES = main.o example_functions.o # List all object files (omit src/ directory)
